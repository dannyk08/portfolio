...
type BaseIconProps = Props & {
  iconName: 'github' | 'linkedin' | 'calendar'
}
...
export default function Base(props: BaseIconProps) {
  ...
  return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...rest}>
    <path
